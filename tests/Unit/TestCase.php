...
namespace Fstarkcyber\RajaOngkir\Tests\Unit;
...
use Fstarkcyber\RajaOngkir\SearchDrivers\FuseDriver;
use Mockery;
use PHPUnit\Framework\TestCase as PHPUnitTestCase;

class TestCase extends PHPUnitTestCase
{
    /** @var \Fstarkcyber\RajaOngkir\Contracts\HttpClientContract|\Mockery\Mock */
    protected $httpClient;

    /** @var \Fstarkcyber\RajaOngkir\Contracts\SearchDriverContract|\Mockery\Mock */
    protected $searchDriver;

    /** @var \Fstarkcyber\RajaOngkir\RajaOngkir */
